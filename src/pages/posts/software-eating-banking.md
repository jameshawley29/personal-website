...
title: 'Software Is Eating Banking: What Fintech Gets Right'
description: 'An analysis of how technology companies are disrupting traditional financial services and what it means for the industry.'
pubDate: 2026-01-15
author: 'James Hawley'
category: 'economics'
visible: false
...
1. **APIs and infrastructure-as-a-service**: Companies like Plaid (account connectivity), Marqeta (card issuing), and Galileo (core banking infrastructure) provide the building blocks that let fintech startups launch without building everything from scratch.

2. **Mobile-first distribution**: Smartphones gave fintech companies a direct channel to consumers, bypassing the branch networks that traditional banks spent decades building.
