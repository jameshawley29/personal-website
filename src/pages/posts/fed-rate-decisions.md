...
title: 'Understanding Fed Rate Decisions: A Framework'
description: 'How I think about Federal Reserve interest rate policy and what to watch when reading FOMC statements.'
pubDate: 2026-01-05
author: 'James Hawley'
category: 'economics'
visible: true
...
1. **Base case**: What does current data and Fed communication suggest?
2. **Risk scenarios**: What could cause them to move more or less aggressively than expected?
3. **Market pricing**: What's already priced in, and where might markets be mispriced?
